...
date=format(as.POSIXct(Sys.time()-3600*3, tz=format(Sys.time(),"%Z")),"%Y%m%d",tz="UTC")
date.fancy=format(as.POSIXct(Sys.time()-3600*3, tz=format(Sys.time(),"%Z")),"%Y-%m-%d",tz="UTC")

# Prefix
prefix="http://dd.weatheroffice.gc.ca/model_gem_regional/10km/grib2/18/"
suffix=".grib2"
