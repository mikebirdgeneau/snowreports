...
\rfoot[]{\small \sffamily \href{http://snow-reports.ca/resorts/castle}{http://snow-reports.ca/resorts/castle}}
...
\vspace*{-0.65in}
{\noindent \sffamily \huge {Castle Mountain}}\\
...
\begin{tabularx}{\textwidth}{ >{\hsize=.75\hsize}X | >{\hsize=.25\hsize}X }
  ...
  \includegraphics[width=0.7\textwidth]{48h_forecast_Castle_precipitation.png} \newline
  \includegraphics[width=0.7\textwidth]{48h_forecast_Castle_temperature.png} \newline
  \includegraphics[width=0.7\textwidth]{48h_forecast_Castle_wind.png} \newline
&
  ...
  \newline
  \small{Location: \href{https://maps.google.ca/maps?q=\Sexpr{round(local.cells[which(local.cells$resort=="Castle"),]$cell.y,3)},\Sexpr{round(local.cells[which(local.cells$resort=="Castle"),]$cell.x,3)}&safe=off&t=p&z=13}{\Sexpr{paste0(round(abs(local.cells[which(local.cells$resort=="Castle"),]$cell.x),3),"W, ",round(local.cells[which(local.cells$resort=="Castle"),]$cell.y,3),"N")}}}
\end{tabularx}
