...
\rfoot[]{\small \sffamily \href{http://snow-reports.ca/resorts/fernie}{http://snow-reports.ca/resorts/fernie}}
...
\begin{tabularx}{\textwidth}{ >{\hsize=.75\hsize}X | >{\hsize=.25\hsize}X }
  ...
  \includegraphics[width=0.7\textwidth]{48h_forecast_Fernie_precipitation.png} \newline
  \includegraphics[width=0.7\textwidth]{48h_forecast_Fernie_temperature.png} \newline
  \includegraphics[width=0.7\textwidth]{48h_forecast_Fernie_wind.png} \newline
&
  ...
  \newline
  \small{Location: \href{https://maps.google.ca/maps?q=\Sexpr{round(local.cells[which(local.cells$resort=="Fernie"),]$cell.y,3)},\Sexpr{round(local.cells[which(local.cells$resort=="Fernie"),]$cell.x,3)}&safe=off&t=p&z=13}{\Sexpr{paste0(round(abs(local.cells[which(local.cells$resort=="Fernie"),]$cell.x),3),"W, ",round(local.cells[which(local.cells$resort=="Fernie"),]$cell.y,3),"N")}}}
\end{tabularx}
