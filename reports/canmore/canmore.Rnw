...
\rfoot[]{\small \sffamily \href{http://snow-reports.ca/weather/cities/canmore}{http://snow-reports.ca/weather/cities/canmore}}
...
\begin{tabularx}{\textwidth}{ >{\hsize=.75\hsize}X | >{\hsize=.25\hsize}X }
  ...
  \includegraphics[width=0.7\textwidth]{48h_forecast_Canmore_precipitation.png} \newline
  \includegraphics[width=0.7\textwidth]{48h_forecast_Canmore_temperature.png} \newline
  \includegraphics[width=0.7\textwidth]{48h_forecast_Canmore_wind.png} \newline
&
  ...
  \newline
  \small{Location: \href{https://maps.google.ca/maps?q=\Sexpr{round(local.cells[which(local.cells$resort=="Canmore"),]$cell.y,3)},\Sexpr{round(local.cells[which(local.cells$resort=="Canmore"),]$cell.x,3)}&safe=off&t=p&z=13}{\Sexpr{paste0(round(abs(local.cells[which(local.cells$resort=="Canmore"),]$cell.x),3),"W, ",round(local.cells[which(local.cells$resort=="Canmore"),]$cell.y,3),"N")}}}
\end{tabularx}
