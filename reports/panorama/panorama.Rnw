...
\rfoot[]{\small \sffamily \href{http://snow-reports.ca/resorts/panorama}{http://snow-reports.ca/resorts/panorama}}
...
\vspace*{-0.65in}
{\noindent \sffamily \huge {Panorama}}\\
...
\begin{tabularx}{\textwidth}{ >{\hsize=.75\hsize}X | >{\hsize=.25\hsize}X }
  ...
  \includegraphics[width=0.7\textwidth]{48h_forecast_Panorama_precipitation.png} \newline
  \includegraphics[width=0.7\textwidth]{48h_forecast_Panorama_temperature.png} \newline
  \includegraphics[width=0.7\textwidth]{48h_forecast_Panorama_wind.png} \newline
&
  ...
  \newline
  \small{Location: \href{https://maps.google.ca/maps?q=\Sexpr{round(local.cells[which(local.cells$resort=="Panorama"),]$cell.y,3)},\Sexpr{round(local.cells[which(local.cells$resort=="Panorama"),]$cell.x,3)}&safe=off&t=p&z=13}{\Sexpr{paste0(round(abs(local.cells[which(local.cells$resort=="Panorama"),]$cell.x),3),"W, ",round(local.cells[which(local.cells$resort=="Panorama"),]$cell.y,3),"N")}}}
\end{tabularx}
